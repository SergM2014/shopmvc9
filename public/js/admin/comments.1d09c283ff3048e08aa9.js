...
var commentsContainer = new Vue({
    ...
    methods: {
        ...
        fillUpMenu: function fillUpMenu(e) {
            ...
            var id = e.target.closest('li').dataset.commentId;
        ...
        showModalWindow: function showModalWindow(commentId) {
        ...
        publishComment: function publishComment(id) {
            ...
            var publishCluster = new FormData(document.getElementById('commentPublishForm'));
            axios({
                method: 'post',
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_helpers__ = __webpack_require__(35);
