...
@section('content')
    ...
    <h1 class="text-danger text-center">Update Product</h1>
    ...
    <form method="post" action="/admin/product/{{ $product->id }}/update">
        ...
        <div class="form-group @if($errors->has('author')) has-error @endif">
            ...
            <input type="text" class="form-control" id="author" name="author" placeholder="enter author" value="{{ old('_token')? old('author'): $product->author }}">
        ...
        <div class="form-group @if($errors->has('title')) has-error @endif">
            ...
            <input type="text" class="form-control" id="title" name="title" placeholder="enter title" value="{{ old('_token')? old('title'): $product->title }}">
            @if($errors->has('title'))
        ...
        <div class="form-group @if($errors->has('description')) has-error @endif">
            ...
            <textarea class="form-control" rows="3" cols="10" id="description" name="description" placeholder="enter description">{{old('_token')? old('description'): $product->description }}</textarea>
        ...
        <div class="form-group @if($errors->has('body')) has-error @endif">
            ...
            <textarea class="form-control" rows="3" cols="10" id="body" name="body" placeholder="enter body">{{ old('_token')? old('body'): $product->body }}</textarea>
            @if($errors->has('body'))
        ...
        <div class="form-group @if($errors->has('price')) has-error @endif">
            ...
            <input type="text" class="form-control" id="price" name="price" placeholder="enter price" value="{{old('_token')? old('price'): $product->price }}">
            @if($errors->has('price'))
        ...
        <div class="form-group">
            ...
            <select  class="form-control" name="manufacturerId" id="manufacturerId">
                @foreach($manufacturers as $manufacturer)
                    ...
                    <?php $choosenManufacturer = old('manufacturerId')?? $product->manufacturer_id; ?>

                 <option value="{{ $manufacturer->id }}" <?= $manufacturer->id == $choosenManufacturer? 'selected': '' ?> >{{ $manufacturer->title }}</option>
